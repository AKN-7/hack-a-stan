...
const PresetGrid = ({
  ...
  <div className="grid gap-4 p-4">
    <div
      ...
      className="flex h-[70px] cursor-pointer items-center justify-center bg-secondary rounded-lg"
    >
      <CircleOff />
    </div>
    ...
    {presets.map((preset, index) => (
      <div
        ...
        className="text-md flex h-[70px] cursor-pointer items-center justify-center bg-secondary rounded-lg overflow-hidden"
      >
        {preset.previewUrl ? (
          <video
