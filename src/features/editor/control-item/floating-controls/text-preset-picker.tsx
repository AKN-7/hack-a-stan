      ...
      <ScrollArea className="h-[400px] w-full py-0">
        <div className="grid grid-cols-3 gap-2 px-4">
          <div
            ...
            className="flex h-[70px] cursor-pointer items-center justify-center bg-secondary"
          >
            <CircleOff />
          </div>
          ...
          {TEXT_PRESETS.map((preset, index) => (
            <div
              ...
              className="text-md flex h-[70px] cursor-pointer items-center justify-center bg-secondary"
            >
              <div
                style={{
