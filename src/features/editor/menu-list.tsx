...
// Simplified for talking-head video editing hackathon
const MENU_ITEMS = [
  {
    id: "chat",
    icon: Icons.messages,
    label: "AI Chat",
    ariaLabel: "Chat with AI to edit video"
  },
  {
    id: "transcript",
    icon: Icons.transcript,
    label: "Transcript",
    ariaLabel: "Edit video via transcript"
  },
  // Transitions hidden for demo - code preserved in menu-item/transitions.tsx
] as const;
